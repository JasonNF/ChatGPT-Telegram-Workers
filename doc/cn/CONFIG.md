...
| TELEGRAM_THINKING_DRAFT_ENABLED | 原生思考草稿动画 | `true`                                          | 私聊优先使用 Telegram 动画草稿；API 不可用时回退为普通消息                                                                                                                                                                                                                          |
| TELEGRAM_THINKING_INTERVAL   | 思考动画间隔          | `900` (number)                                  | 点动画的帧间隔，单位毫秒                                                                                                                                                                                                                                                                        |
| TELEGRAM_THINKING_LABEL      | 思考标识文字          | `MOSS`                                          | 动态点前显示的名称                                                                                                                                                                                                                                                                              |
| TELEGRAM_THINKING_CUSTOM_EMOJI_ID | 思考动态图标       | `''`                                            | Telegram `custom_emoji_id`；留空时显示红色圆点                                                                                                                                                                                                                                                     |
