...
| TELEGRAM_THINKING_DRAFT_ENABLED | Native thinking draft animation | `true`                                          | Prefer Telegram animated drafts in private chats and fall back to a regular message when unavailable                                                                                                                                                                                                    |
| TELEGRAM_THINKING_INTERVAL   | Thinking animation interval       | `900` (number)                                  | Dot animation frame interval in milliseconds                                                                                                                                                                                                                                                            |
| TELEGRAM_THINKING_LABEL      | Thinking indicator label          | `MOSS`                                          | Label displayed before the animated dots                                                                                                                                                                                                                                                                |
